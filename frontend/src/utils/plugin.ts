...
const PluginEditor = {
    ...
    setup(props: any, { emit }: any) {
        ...
        function create(viewEl: HTMLElement) {
            const exts: any[] = [lineNumbers(), history(), keymap.of([...defaultKeymap, ...historyKeymap]), oneDark, EditorView.lineWrapping, indentUnit.of('    '), indentationMarkers()]
...
export function Plugin(config: PluginConfig) {
    ...
    const TABPAGES_CSS = [
        ...
        '.plugin-editor{position:relative;height:320px}',
        '.plugin-editor .cm-editor{height:100%;outline:none}',
        '.plugin-editor .cm-scroller{font-family:monospace;line-height:1.5;overflow-y:auto}',
